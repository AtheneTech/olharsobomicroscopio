...
export const galleriesByYear =  {
  ...
  },
  {
    ...
    />
      ...
      { icon: <img src="/icons/iconzoomin.png" style={{ width: 65, height: 65}}/>, label: "Amostra", popupType: "amostra", position: { top: "40%", left: "50%" }, size: 90, popupContent: <ZoomPreview src="/photos/asm/raiva.png" />},
    ...
    />
      ...
      { icon: <img src="/icons/iconsound.png" style={{ width: 30, height: 30}}/>, label: "Som", popupType: "som", position: { top: "35%", left: "10%" }, size: 45, popupContent: <SoundPreview trackId="1qrpoAMXodY6895hGKoUpA" /> },
  ...
  {
    name: "Nome 5",
    src: "/photos/asm/esporotricose.png",
         extraIcon: {
    icon: <img src="/icons/chagas.png" style={{ width: 32, height: 32 }} />,},
